...
ALTER TABLE `HABITACION` 
 ADD INDEX `IXFK_HABITACION_RESERVA` (`COD_RESERVA` ASC)
;
...
ALTER TABLE `HABITACION` 
 ADD CONSTRAINT `FK_HABITACION_RESERVA`
	FOREIGN KEY (`COD_RESERVA`) REFERENCES `RESERVA` (`COD_RESERVA`) ON DELETE Restrict ON UPDATE Restrict
;
